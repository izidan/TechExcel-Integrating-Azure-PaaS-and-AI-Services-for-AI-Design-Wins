...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a hotel from a sepcific date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The bookings from date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get all bookings for all hotels with missing rooms.")]
    ...
    [KernelFunction]
    [Description("Get all bookings for all hotels with multiple rooms.")]
